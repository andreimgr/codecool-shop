        ...
        for (item of items) {
            let outerHTML =
                `<tr>
                    ...
                    <td>${item.quantity}</td>
                    <td class="text-start">
                        <i class="bi bi-plus-circle productIncrease" data-productId="${item.productId}"></i>
                        <i class="bi bi-dash-circle productDecrease" data-productId="${item.productId}"></i>
                    </td>
                    <td class="text-end pe-3">${item.linePrice}</td>
                    <td><i class="bi bi-trash lineRemover" data-productId="${item.productId}"></i></td>
                </tr>`
